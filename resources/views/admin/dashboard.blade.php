        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="mt-1 text-gray-600 dark:text-gray-400">Ini adalah pusat kendali web aplikasi. Anda dapat
                        mengelola mahasiswa dan
                ...
                <div
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-lg font-bold text-gray-900">Kelola portofolio mahasiswa</p>
                            </div>
                        </div>
                        <div class="mt-4 flex space-x-2">
                            <a href="{{ route('admin.portfolios.index') }}"
                                class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">Lihat Semua Portofolio
                                &rarr;</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="{{ route('admin.portfolios.index') }}"
                                    class="text-sm text-indigo-600 hover:text-indigo-900 dark:text-indigo-400">Lihat
                                    Semua</a>
                            </div>
                                        ...
                                        <thead class="bg-gray-50 dark:bg-gray-900">
                                            <tr>
                                                ...
                                                <th
                                                    class="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300">
                                                    Tahun Masuk</th>
                                                <th class="px-4 py-2 text-center text-xs font-medium text-gray-500">Aksi
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody
                                            ...
                                            @foreach ($recentPortfolios as $portfolio)
                                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900">
                                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-100">
                                                        {{ $portfolio->nama_proyek ?? 'Untitled' }}</td>
                                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-100">
                                                        {{ $portfolio->user?->name ?? 'Unknown' }}</td>
                                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-100">
                                                        {{ $portfolio->user?->tahun_masuk ?? '-' }}</td>
                                                    <td class="px-4 py-3 text-sm text-center">
                                                        <a href="{{ route('portfolio.show', $portfolio->id) }}"
                                                            class="text-indigo-600 hover:underline dark:text-indigo-400">Lihat</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="lg:col-span-1">
                                ...
                                <ul class="mt-4 space-y-3">
                                    @foreach ($latestStudents as $s)
                                        <li class="flex items-center gap-3">
                                            @if ($s->profile_photo)
                                                <img src="{{ asset('storage/' . $s->profile_photo) }}" alt="avatar"
                                                    class="h-10 w-10 rounded-full object-cover">
                                            @else
                                                <div
                                                    class="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-200">
                                                    {{ Str::substr($s->name, 0, 1) }}</div>
                                            @endif
                                            <div class="text-sm">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="mt-3">
                                <div
                                    class="flex items-center justify-between text-sm text-gray-700 dark:text-gray-100">
                                    <div>Dengan Foto</div>
                                ...
                                <div
                                    class="flex items-center justify-between text-sm text-gray-700 dark:text-gray-100 mt-3">
                                    <div>Tanpa Foto</div>
