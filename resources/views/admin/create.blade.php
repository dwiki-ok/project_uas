            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-8 text-gray-900">
                    ...
                    <div class="mb-6 text-center">
                        <h3 class="text-lg font-bold text-gray-900">Form Data Mahasiswa</h3>
                        <p class="text-sm text-gray-500">Lengkapi data berikut untuk membuat akun direktori portofolio.
                        </p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-700 mb-2" for="photo">
                                Foto Profil
                            </label>
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0">
                                    <div
                                        class="h-16 w-16 object-cover rounded-full bg-gray-200 flex items-center justify-center text-gray-400">
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-700" for="name">Nama Lengkap</label>
                            <input id="name"
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-700" for="prodi">Program Studi</label>
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-700" for="nrp">NRP</label>
                            <input id="nrp"
                                class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div>
                            <label class="block font-medium text-sm text-gray-700" for="tahun_masuk">Tahun Masuk</label>
