        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="text-sm text-gray-500 mb-4">Oleh: {{ $portfolio->user?->name ?? 'Unknown' }} •
                        {{ $portfolio->created_at?->format('Y') ?? '-' }}</div>
                    ...
                    <div class="mt-6">
                        <a href="{{ url()->previous() }}"
                            class="inline-block px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
