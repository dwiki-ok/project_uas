<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            @if (isset($user))
                <span class="text-sm text-gray-600 dark:text-gray-400">Selamat datang, <strong>{{ $user->name }}</strong></span>
            @endif
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="w-12 h-12 text-blue-300 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M2 6a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM4 9h12v5H4V9z"></path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6 text-white">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="w-12 h-12 text-purple-300 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 3.062v2.332c0 2.992-1.635 5.6-4.06 7.001-2.425-1.401-4.06-4.009-4.06-7V6.517a3.066 3.066 0 012.812-3.062zM9 13a1 1 0 11-2 0 1 1 0 012 0z" clip-rule="evenodd"></path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6 text-white">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="w-12 h-12 text-orange-300 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v1h8v-1zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-1a4 4 0 00-4-4h-2.5a4 4 0 00-4 4v1h10.5z"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-{{ $user->profile_photo ? 'green' : 'red' }}-500 h-2 rounded-full" style="width: {{ $user->profile_photo ? '100' : '0' }}%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-{{ $user->prodi ? 'green' : 'red' }}-500 h-2 rounded-full" style="width: {{ $user->prodi ? '100' : '0' }}%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-{{ $user->tahun_masuk ? 'green' : 'red' }}-500 h-2 rounded-full" style="width: {{ $user->tahun_masuk ? '100' : '0' }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if (isset($user))
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 p-4 bg-indigo-50 dark:bg-indigo-900 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-800 transition">
                        ...
                        <a href="{{ route('portfolio.create') }}" class="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900 rounded-lg hover:bg-green-100 dark:hover:bg-green-800 transition">
                        ...
                        <a href="{{ route('portfolio.index') }}" class="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition">
            ...
            <!-- Statistik Tab -->
            <div id="statistik" class="tab-content hidden bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if (isset($user))
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Portfolio Statistics -->
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md p-6">
                                <h3 class="text-xl font-semibold text-indigo-600 mb-6">📊 Statistik Portfolio</h3>
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        ...
                                        <span class="text-2xl font-bold text-indigo-600">{{ $portfolios->count() }}</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        <span class="text-gray-700 dark:text-gray-300">Portfolio dengan CV</span>
                                        <span class="text-2xl font-bold text-green-600">{{ $portfolios->where('pdf_file', '!=', null)->count() }}</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        <span class="text-gray-700 dark:text-gray-300">Portfolio Tanpa CV</span>
                                        <span class="text-2xl font-bold text-orange-600">{{ $portfolios->where('pdf_file', null)->count() }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md p-6">
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        ...
                                        <span class="text-2xl font-bold text-purple-600">{{ $allMahasiswa->count() }}</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        <span class="text-gray-700 dark:text-gray-300">Mahasiswa Aktif Lainnya</span>
                                        <span class="text-2xl font-bold text-blue-600">{{ $allMahasiswa->count() }}</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded">
                                        <span class="text-gray-700 dark:text-gray-300">Mahasiswa dengan Foto</span>
                                        <span class="text-2xl font-bold text-pink-600">{{ $allMahasiswa->where('profile_photo', '!=', null)->count() + ($user->profile_photo ? 1 : 0) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <div class="bg-gray-50 dark:bg-gray-900 rounded-lg shadow-md p-6">
                                    ...
                                    @if ($portfolios->isEmpty())
                                        <p class="text-gray-600 dark:text-gray-400 text-center py-6">Belum ada portfolio. <a href="{{ route('portfolio.create') }}" class="text-indigo-600 hover:text-indigo-800 font-semibold">Buat sekarang</a></p>
                                    @else
                                        <div class="overflow-x-auto">
                                            <table class="min-w-full text-sm">
                                                <thead>
                                                    <tr class="border-b border-gray-200 dark:border-gray-700">
                                                        <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Nama Proyek</th>
                                                        <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">Keahlian</th>
                                                        <th class="text-left py-3 px-4 font-semibold text-gray-700 dark:text-gray-300">CV</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($portfolios as $p)
                                                        <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-800">
                                                            <td class="py-3 px-4 text-gray-700 dark:text-gray-300">{{ $p->nama_proyek }}</td>
                                                            <td class="py-3 px-4">
                                                                <span class="inline-block bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 px-2 py-1 rounded text-xs">
                                                                    {{ $p->keahlian }}
                                                                </span>
                                                            </td>
                                                            <td class="py-3 px-4">
                                                                @if ($p->pdf_file)
                                                                    <a href="{{ asset('storage/' . $p->pdf_file) }}" target="_blank" class="text-green-600 hover:text-green-800 font-semibold">✓ Ada</a>
                                                                @else
